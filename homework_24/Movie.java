...
public class Movie implements Serializable {
	...
	public static Movie inputMovie() throws IllegalTimeFormatException {
		...
		System.out.print("Введіть назву фільма: ");
		String title = scanner.nextLine();
		if (title.equals("")) {
			System.err.println("Назву фільма введено некорректно!");
			title = "-= Mission Impossible 6 =-";
		}

		System.out.print("Тривалість фільма - ");
	...
	public String toString() {
		if (title == "-= Mission Impossible 6 =-" || title == "-= Технічна перерва =-") {
