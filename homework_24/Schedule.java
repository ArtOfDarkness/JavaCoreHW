...
public class Schedule implements Serializable {
	...
	private final Movie technicalBreakMovie = new Movie("-= Технічна перерва =-", technicalBreakTime);
	...
	public boolean addSeance(Movie movie) throws IllegalTimeFormatException {
		...
		if (isSeanceTimeFree(seance)) {
			...
			System.out.println("Сеанс успішно добавлений в розклад!\n");
			return true;
		} else {
			System.err.println("Добавлення сеанса в розклад неможливо,тому що данний час занятий!\n");
			return false;
		}
	}
	...
	public boolean removeSeance(Seance removingSeance) throws IllegalTimeFormatException {
		...
		if (removingSeanceFound.isPresent()) {
			...
			System.out.println("Сеанс успішно видалений із розкладу!\n");
			return true;
		} else {
			System.err.println("Введений сеанс відсутній в розкладі!\n");
			return false;
		}
	}
	
	public void viewSchedule() {
		System.out.println("Розклад сеансів:");
