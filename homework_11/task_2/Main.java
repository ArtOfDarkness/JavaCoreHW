...
public class Main {
	...
	static void menu() {
		System.out.println();
		System.out.println("Введіть 1, щоб вивести масив випадкових авто");
		System.out.println("Введіть 2, щоб заповнити массив одинаковими значеннями випадкового авто");
	}
