...
public final class SupremeCouncil {
	...
	public void addDeputyGroup() {
		...
		System.out.println(deputyGroup.toString() + " Успішно добавлена в Верховну Раду!");
	}
	...
	public void removeDeputyGroup() {
		...
		if (deputyGroupFound.isPresent()) {
			...
			System.out.println(deputyGroupFound.get().toString() + " успішно видалена із Верховної Ради!");
		} else {
	...
	public void getAllDeputyGroups() {
		System.out.println("Фракції  зареєстровані в Верхоній Раді:");
